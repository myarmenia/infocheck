    ...
    var l = function (a, t) {
        var n, e = a.data("jscroll"), l = "function" == typeof t ? {callback: t} : t,
            ...
            c = m.trim(o.prop("href") + " " + s.contentSelector), g = function () {
                ...
                return r.waiting = !0, t.append('<div class="jscroll-added wow fadeIn" />').children(".jscroll-added").last().html('<div class="jscroll-loading" id="jscroll-loading">' + s.loadingHtml + "</div>").promise().done(function () {
